...
public RespJson
<IPage
<${tableInfo.tableNameGreatHump}Vo>> getByPage(@ParameterObject ${tableInfo.tableNameGreatHump}PageDto dto) {
    ...
    */
    ...
    public RespJson
    <${tableInfo.tableNameGreatHump}Vo> queryById(@Parameter(description = "主键", required = true) String id) {
        ...
        */
        ...
        <TreeNode>> getTree() {
            ...
            */
            ...
            public RespJson
            <Boolean> insert(@RequestBody @Validated ${tableInfo.tableNameGreatHump}InsertDto dto) {
                ...
                */
                ...
                public RespJson
                <Boolean> updateById(@RequestBody @Validated ${tableInfo.tableNameGreatHump}UpdateDto dto) {
                    ...
                    */
                    ...
                    public RespJson
                    <Boolean> deleteBatchByIdList(@Parameter(description = "${tableInfo.tableComment!}id逗号字符串",
                        required = true) @RequestParam List
                        <String> idList) {
